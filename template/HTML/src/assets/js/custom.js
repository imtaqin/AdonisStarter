(function () {
  ...
  function toggleTheme() {
    ...
    if (html.getAttribute("data-theme-mode") === "dark") {
      ...
      localStorage.removeItem("Imtaqindarktheme");
      localStorage.removeItem("ImtaqinMenu");
      localStorage.removeItem("ImtaqinHeader");
      ...
      document.querySelector("#switcher-background1").checked = false;
      document.querySelector("#switcher-background").checked = false;
      localStorage.setItem("Imtaqindarktheme", "true");
      localStorage.setItem("ImtaqinMenu", "dark");
      localStorage.setItem("ImtaqinHeader", "dark");
      localStorage.removeItem("bodylightRGB");
      localStorage.removeItem("bodyBgRGB");
    }
  }
