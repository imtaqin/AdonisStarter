...
var e = Object.defineProperty, t = /* @__PURE__ */ ((t, n) => {
	...
	adjustableInputNumbers: () => l,
	createElementFromString: () => a,
	createFromTemplate: () => o,
	eventPath: () => s,
	off: () => i,
	on: () => r,
	resolveElement: () => c
...
var r = n.bind(null, "addEventListener"), i = n.bind(null, "removeEventListener");
function a(e) {
...
function l(e, t = (e) => e) {
	function n(n) {
		let r = [
			...
			.01,
			.1
		][Number(n.shiftKey || n.ctrlKey * 2)] * (n.deltaY < 0 ? 1 : -1), i = 0, a = e.selectionStart;
	...
	r(e, "focus", () => r(window, "wheel", n, { passive: !1 })), r(e, "blur", () => i(window, "wheel", n));
}
//#endregion
//#region src/js/utils/color.js
var { min: u, max: d, floor: f, round: p } = Math;
function m(e) {
...
function h(e, t, n) {
	...
	let r = f(e), i = e - r, a = n * (1 - t), o = n * (1 - i * t), s = n * (1 - (1 - i) * t), c = r % 6, l = [
		n,
		o,
		a,
		a,
...
function g(e, t, n) {
	return h(e, t, n).map((e) => p(e).toString(16).padStart(2, "0"));
}
function _(e, t, n) {
	let r = h(e, t, n), i = r[0] / 255, a = r[1] / 255, o = r[2] / 255, s = u(1 - i, 1 - a, 1 - o), c = s === 1 ? 0 : (1 - i - s) / (1 - s), l = s === 1 ? 0 : (1 - a - s) / (1 - s), d = s === 1 ? 0 : (1 - o - s) / (1 - s);
	return [
		c * 100,
		l * 100,
		d * 100,
...
function v(e, t, n) {
	t /= 100, n /= 100;
	let r = (2 - t) * n / 2;
	return r !== 0 && (t = r === 1 ? 0 : r < .5 ? t * n / (r * 2) : t * n / (2 - r * 2)), [
		e,
		t * 100,
		r * 100
	];
...
function y(e, t, n) {
	e /= 255, t /= 255, n /= 255;
	let r = u(e, t, n), i = d(e, t, n), a = i - r, o, s, c = i;
	if (a === 0) o = s = 0;
	else {
		s = a / i;
...
function b(e, t, n, r) {
	return e /= 100, t /= 100, n /= 100, r /= 100, [...y((1 - u(1, e * (1 - r) + r)) * 255, (1 - u(1, t * (1 - r) + r)) * 255, (1 - u(1, n * (1 - r) + r)) * 255)];
}
function x(e, t, n) {
	t /= 100, n /= 100, t *= n < .5 ? n : 1 - n;
	let r = 2 * t / (n + t) * 100, i = (n + t) * 100;
	return [
		e,
		isNaN(r) ? 0 : r,
		i
...
function S(e) {
	return y(...e.match(/.{2}/g).map((e) => parseInt(e, 16)));
}
function C(e) {
	e = e.match(/^[a-zA-Z]+$/) ? m(e) : e;
	let t = {
	...
	invalid: for (let i in t) if (r = t[i].exec(e)) switch (i) {
		case "cmyk": {
			let [, e, t, a, o] = n(r);
			if (e > 100 || t > 100 || a > 100 || o > 100) break invalid;
			return {
				values: b(e, t, a, o),
				type: i
			};
		...
		case "rgba": {
			let [, e, , t, , a, , , o] = n(r);
			if (e = r[2] === "%" ? e / 100 * 255 : e, t = r[4] === "%" ? t / 100 * 255 : t, a = r[6] === "%" ? a / 100 * 255 : a, o = r[9] === "%" ? o / 100 : o, e > 255 || t > 255 || a > 255 || o < 0 || o > 1) break invalid;
			return {
				values: [...y(e, t, a), o],
				a: o,
				type: i
		...
		case "hsla": {
			let [, e, t, a, , o] = n(r);
			if (o = r[6] === "%" ? o / 100 : o, e > 360 || t > 100 || a > 100 || o < 0 || o > 1) break invalid;
			return {
				values: [...x(e, t, a), o],
				a: o,
				type: i
...
//#endregion
//#region src/js/utils/hsvacolor.js
function w(e = 0, t = 0, n = 0, r = 1) {
	let i = (e, t) => (n = -1) => t(~n ? e.map((e) => Number(e.toFixed(n))) : e), a = {
		...
		toHEXA() {
			let e = g(a.h, a.s, a.v), t = a.a >= 1 ? "" : Number((a.a * 255).toFixed(0)).toString(16).toUpperCase().padStart(2, "0");
			return t && e.push(t), e.toString = () => `#${e.join("").toUpperCase()}`, e;
		},
		clone: () => w(a.h, a.s, a.v, a.a)
	};
	return a;
}
//#endregion
//#region src/js/libs/moveable.js
var T = (e) => Math.max(Math.min(e, 1), 0);
function E(e) {
	let t = {
		...
		_keyboard(e) {
			...
			if (document.activeElement === n.wrapper) {
				...
				if (r === "keydown" && (a || o || s || c)) {
					let r = 0, i = 0;
					n === "v" ? r = a || o ? 1 : -1 : n === "h" ? r = a || o ? -1 : 1 : (i = a ? -1 : +!!s, r = c ? -1 : +!!o), t.update(T(t.cache.x + .01 * r), T(t.cache.y + .01 * i)), e.preventDefault();
		...
		_tapstart(e) {
			r(document, [
				...
				"touchend",
				"touchcancel"
			], t._tapstop), r(document, ["mousemove", "touchmove"], t._tapmove), e.cancelable && e.preventDefault(), t._tapmove(e);
		},
		_tapmove(e) {
			...
			let u = T(c / s.width), d = T(l / s.height);
			switch (i) {
		...
		_tapstop() {
			t.options.onstop(), i(document, [
				"mouseup",
				"touchend",
				"touchcancel"
			], t._tapstop), i(document, ["mousemove", "touchmove"], t._tapmove);
		},
		trigger() {
			t._tapmove();
		},
		...
		destroy() {
			...
			i(document, ["keydown", "keyup"], r), i([e.wrapper, e.element], "mousedown", n), i([e.wrapper, e.element], "touchstart", n, { passive: !1 });
		}
	}, { options: n, _tapstart: a, _keyboard: o } = t;
	return r([n.wrapper, n.element], "mousedown", a), r([n.wrapper, n.element], "touchstart", a, { passive: !1 }), r(document, ["keydown", "keyup"], o), t;
}
//#endregion
//#region src/js/libs/selectable.js
function D(e = {}) {
	e = Object.assign({
		onchange: () => 0,
		className: "",
	...
	let t = r(e.elements, "click", (t) => {
		e.elements.forEach((n) => n.classList[t.target === n ? "add" : "remove"](e.className)), e.onchange(t), t.stopPropagation();
	});
	return { destroy: () => i(...t) };
}
//#endregion
//#region src/js/template.js
var O = (e) => {
	let { components: t, useAsButton: n, inline: r, appClass: i, theme: a, lockOpacity: s } = e.options, c = (e) => e ? "" : "style=\"display:none\" hidden", l = (t) => e._t(t), u = o(`
      <div :ref="root" class="pickr">

        ${n ? "" : "<button type=\"button\" :ref=\"button\" class=\"pcr-button\"></button>"}

        <div :ref="app" class="pcr-app ${i || ""}" data-theme="${a}" ${r ? "style=\"position: unset\"" : ""} aria-label="${l("ui:dialog", "color picker dialog")}" role="window">
          <div class="pcr-selection" ${c(t.palette)}>
            ...
            <div :obj="opacity" class="pcr-color-opacity" ${c(t.opacity)}>
              <div :ref="picker" class="pcr-picker"></div>
              <div :ref="slider" class="pcr-opacity pcr-slider" tabindex="0" aria-label="${l("aria:opacity", "opacity selection slider")}" role="slider"></div>
            </div>
          </div>
          ...
          <div :obj="interaction" class="pcr-interaction" ${c(Object.keys(t.interaction).length)}>
            <input :ref="result" class="pcr-result" type="text" spellcheck="false" ${c(t.interaction.input)} aria-label="${l("aria:input", "color input field")}">
		...
		if (!(r < g || r + c + o > u)) for (let u of y) {
			...
			if (!(m < _ || m + l + o > d)) {
				if (m -= p[s], r -= p[a], t.style[s] = `${m}px`, t.style[a] = `${r}px`, i) {
					let t = n ? f.width / 2 : f.height / 2, o = l / 2, d = t > o, p = {
						s: d ? o : t,
						m: o,
						e: d ? o : l - t
					}, h = {
	...
	let r = typeof e == "object" && !(e instanceof HTMLElement) ? e : {
		reference: e,
		popper: t,
		...n
	};
	...
	constructor(t) {
		...
		let { swatches: n, components: r, theme: i, sliders: a, lockOpacity: o, padding: s } = t;
		["nano", "monolith"].includes(i) && !a && (t.sliders = "h"), r.interaction ||= {};
		let { preview: c, opacity: l, hue: u, palette: d } = r;
		r.opacity = !o && l, r.palette = d || c || l || u, this._preBuild(), this._buildComponents(), this._bindEvents(), this._finalBuild(), n && n.length && n.forEach((e) => this.addSwatch(e));
		let { button: f, app: p } = this._root;
		this._nanopop = j(f, p, { margin: s }), f.setAttribute("role", "button"), f.setAttribute("aria-label", this._t("btn:toggle"));
		let m = this;
		this._setupAnimationFrame = requestAnimationFrame((function e() {
			if (!p.offsetWidth) return requestAnimationFrame(e);
			m.setColor(t.default), m._rePositioningPicker(), t.defaultRepresentation && (m._representation = t.defaultRepresentation, m.setColorRepresentation(m._representation)), t.showAlways && m.show(), m._initializingActive = !1, m._emit("init");
		}));
	}
	static create = (t) => new e(t);
	_preBuild() {
		let { options: e } = this;
		for (let t of ["el", "container"]) e[t] = c(e[t]);
		this._root = O(this), e.useAsButton && (this._root.button = e.el), e.container.appendChild(this._root.root);
	}
	_finalBuild() {
		...
		let e = this, t = this.options.components, n = (e.options.sliders || "v").repeat(2), [r, i] = n.match(/^[vh]+$/g) ? n : [], a = () => this._color ||= this._lastColor.clone(), o = {
			palette: E({
				...
				onchange(n, r) {
					...
					e._recalc && (i.s = n * 100, i.v = 100 - r * 100, i.v < 0 && (i.v = 0), e._updateOutput("slider"));
			...
			hue: E({
				...
				onchange(n) {
					...
					let r = a();
					e._recalc && (r.h = n * 360), this.element.style.backgroundColor = `hsl(${r.h}, 100%, 50%)`, o.palette.trigger();
				}
			}),
			opacity: E({
				lock: r === "v" ? "h" : "v",
				...
				onchange(n) {
					...
					let r = a();
					e._recalc && (r.a = Math.round(n * 100) / 100), this.element.style.background = `rgba(0, 0, 0, ${r.a})`, o.palette.trigger();
				}
			}),
			selectable: D({
	...
	_bindEvents() {
		let { _root: e, options: t } = this, n = [
			r(e.interaction.clear, "click", () => this._clearColor()),
			r([e.interaction.cancel, e.preview.lastColor], "click", () => {
				this.setHSVA(...(this._lastColor || this._color).toHSVA(), !0), this._emit("cancel");
			}),
			r(e.interaction.save, "click", () => {
				!this.applyColor() && !t.showAlways && this.hide();
			}),
			r(e.interaction.result, ["keyup", "input"], (e) => {
			...
			r(e.interaction.result, ["focus", "blur"], (e) => {
		...
		if (!t.showAlways) {
			let i = t.closeWithKey;
			n.push(r(e.button, "click", () => this.isOpen() ? this.hide() : this.show()), r(document, "keyup", (e) => this.isOpen() && (e.key === i || e.code === i) && this.hide()), r(document, ["touchstart", "mousedown"], (t) => {
				this.isOpen() && !s(t).some((t) => t === e.app || t === e.button) && this.hide();
			}, { capture: !0 }));
		}
		if (t.adjustableNumbers) {
			...
			l(e.interaction.result, (e, n, r) => {
				let i = t[this.getColorRepresentation().toLowerCase()];
				if (i) {
					let t = i[r], a = e + (t >= 100 ? n * 1e3 : n);
		...
		if (t.autoReposition && !t.inline) {
			let e = null, i = this;
			n.push(r(window, ["scroll", "resize"], () => {
				i.isOpen() && (t.closeOnScroll && i.hide(), e === null ? (e = setTimeout(() => e = null, 100), requestAnimationFrame(function t() {
					i._rePositioningPicker(), e !== null && requestAnimationFrame(t);
	...
	_parseLocalColor(e) {
		let { values: t, type: n, a: r } = C(e), { lockOpacity: i } = this.options, a = r !== void 0 && r !== 1;
	...
	addSwatch(e) {
		...
		if (t) {
			let { _swatchColors: e, _root: n } = this, i = w(...t), o = a(`<button type="button" style="--pcr-color: ${i.toRGBA().toString(0)}" aria-label="${this._t("btn:swatch")}"/>`);
			return n.swatches.appendChild(o), e.push({
				el: o,
				color: i
			}), this._eventBindings.push(r(o, "click", () => {
				this.setHSVA(...i.toHSVA(), !0), this._emit("swatchselect", i), this._emit("change", i, "swatch", this);
			})), !0;
		}
		return !1;
	}
	...
	destroy() {
		cancelAnimationFrame(this._setupAnimationFrame), this._eventBindings.forEach((e) => i(...e)), Object.keys(this._components).forEach((e) => this._components[e].destroy());
	}
	destroyAndRemove() {
		this.destroy();
	...
	setColor(e, t = !1) {
		...
		if (n) {
			...
			return this.setHSVA(...n, t) ? this.setColorRepresentation(e) : !1;
		}
		return !1;
	}
...
//# sourceMappingURL=pickr.min.mjs.map