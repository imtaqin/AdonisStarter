...
(() => {
  ...
  if (
    !localStorage.getItem("Imtaqinlayout") &&
    !localStorage.getItem("Imtaqinnavstyles") &&
    !localStorage.getItem("Imtaqinverticalstyles") &&
      ...
      switch (verticalStyle) {
        ...
        case "overlay":
          ...
          if (html.getAttribute('data-toggled') === 'icon-overlay-close') {
            ...
            if (window.innerWidth >= 992) {
              if (!localStorage.getItem("Imtaqinlayout")) {
