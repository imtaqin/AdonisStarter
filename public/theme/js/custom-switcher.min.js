...
function switcherClick() {
    ...
    let lightThemeVar = lightBtn.addEventListener('click', () => {
        lightFn();
        localStorage.setItem("ImtaqinHeader", 'light');
        // localStorage.setItem("ImtaqinMenu", 'light');
    ...
    let colorMenuVar = colorMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("ImtaqinMenu", 'color');
    });
    /* Color Menu End */
    ...
    let gradientMenuVar = gradientMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("ImtaqinMenu", 'gradient');
    });
    /* Gradient Menu End */
    ...
    let transparentMenuVar = transparentMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("ImtaqinMenu", 'transparent');
    });
    ...
    let colorHeaderVar = colorHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("ImtaqinHeader", 'color');
    });
    /* Color Header End */
    ...
    let gradientHeaderVar = gradientHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("ImtaqinHeader", 'gradient');
    });
    /* Gradient Header End */
    ...
    let transparentHeaderVar = transparentHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("ImtaqinHeader", 'transparent');
    });
    ...
    let fullwidthVar = fullwidthBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("Imtaqinfullwidth", true);
        localStorage.removeItem("Imtaqinboxed");
    });
    ...
    let boxedVar = boxedBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("Imtaqinboxed", true);
        localStorage.removeItem("Imtaqinfullwidth");
        checkHoriMenu()
    });
    /* Boxed Layout End */
    ...
    let shadowVar = regular.addEventListener('click', () => {
        ...
        localStorage.setItem("Imtaqinregular", true);
        localStorage.removeItem("Imtaqinclassic");
        localStorage.removeItem("Imtaqinmodern");
    });
    ...
    let noShadowVar = classic.addEventListener('click', () => {
        ...
        localStorage.setItem("Imtaqinclassic", true);
        localStorage.removeItem("Imtaqinregular");
        localStorage.removeItem("Imtaqinmodern");
    });
    ...
    let modernVar = modern.addEventListener('click', () => {
        ...
        localStorage.setItem("Imtaqinmodern", true);
        localStorage.removeItem("Imtaqinregular");
        localStorage.removeItem("Imtaqinclassic");
    });
    ...
    let fixedHeaderVar = fixedHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("Imtaqinheaderfixed", true);
        localStorage.removeItem("Imtaqinheaderscrollable");
    });

    let scrollHeaderVar = scrollHeaderBtn.addEventListener('click', () => {
        html.setAttribute('data-header-position', 'scrollable');
        localStorage.setItem("Imtaqinheaderscrollable", true);
        localStorage.removeItem("Imtaqinheaderfixed");
    });
    ...
    let fixedMenuVar = fixedMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("Imtaqinmenufixed", true);
        localStorage.removeItem("Imtaqinmenuscrollable");
    });

    let scrollMenuVar = scrollMenuBtn.addEventListener('click', () => {
        html.setAttribute('data-menu-position', 'scrollable');
        localStorage.setItem("Imtaqinmenuscrollable", true);
        localStorage.removeItem("Imtaqinmenufixed");
    });
    ...
    let closedVar = closedBtn.addEventListener('click', () => {
        closedSidemenuFn();
        localStorage.setItem("Imtaqinverticalstyles", 'closed');
    });
    /* Closed Sidemenu End */
    ...
    let detachedVar = detachedBtn.addEventListener('click', () => {
        detachedFn();
        localStorage.setItem("Imtaqinverticalstyles", 'detached');
    });
    /* Hover Submenu End */
    ...
    let iconTextVar = iconTextBtn.addEventListener('click', () => {
        iconTextFn();
        localStorage.setItem("Imtaqinverticalstyles", 'icontext');
    });
    ...
    let overlayVar = overlayBtn.addEventListener('click', () => {
        iconOverayFn();
        localStorage.setItem("Imtaqinverticalstyles", 'overlay');
    });
    ...
    let doubleVar = doubleBtn.addEventListener('click', () => {
        doubletFn();
        localStorage.setItem("Imtaqinverticalstyles", 'doublemenu');
    });
    ...
    let menuClickVar = menuClickBtn.addEventListener('click', () => {
        ...
        menuClickFn();
        localStorage.setItem("Imtaqinnavstyles", 'menu-click');
        localStorage.removeItem("Imtaqinverticalstyles");
    ...
    let menuhoverVar = menuHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        menuhoverFn();
        localStorage.setItem("Imtaqinnavstyles", 'menu-hover');
        localStorage.removeItem("Imtaqinverticalstyles");
    ...
    let iconClickVar = iconClickBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconClickFn();
        localStorage.setItem("Imtaqinnavstyles", 'icon-click');
        localStorage.removeItem("Imtaqinverticalstyles");
    ...
    let iconhoverVar = iconHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconHoverFn();
        localStorage.setItem("Imtaqinnavstyles", 'icon-hover');
        localStorage.removeItem("Imtaqinverticalstyles");
    ...
    let verticalVar = verticalBtn.addEventListener('click', () => {
        ...
        // local storage
        localStorage.removeItem("Imtaqinlayout");
        localStorage.setItem("Imtaqinverticalstyles", 'default');
        verticalFn();
        setNavActive();
    ...
    let horiVar = horiBtn.addEventListener('click', () => {
        ...
        html.removeAttribute('data-vertical-style');
        //    local storage
        localStorage.setItem("Imtaqinlayout", 'horizontal');
        localStorage.removeItem("Imtaqinverticalstyles");
    ...
    let rtlVar = rtlBtn.addEventListener('click', () => {
        localStorage.setItem("Imtaqinrtl", true);
        localStorage.removeItem("Imtaqinltr");
        rtlFn(); 
    ...
    let ltrVar = ltrBtn.addEventListener('click', () => {
        //    local storage
        localStorage.setItem("Imtaqinltr", true);
        localStorage.removeItem("Imtaqinrtl");
        ltrFn();
        if (document.querySelector(".noUi-target")) {
            document.querySelectorAll(".noUi-origin").forEach((e) => {
...
function ltrFn() {
    ...
    if(!document.querySelector("#style").href.includes('bootstrap.min.css')){
        document.querySelector("#style")?.setAttribute("href", "/theme/libs/bootstrap/css/bootstrap.min.css");
    }
...
function lightFn() {
    ...
    localStorage.removeItem("ImtaqinbgColor");
    localStorage.removeItem("Imtaqinheaderbg");
    localStorage.removeItem("Imtaqinbgwhite");
    localStorage.removeItem("Imtaqinmenubg");
    localStorage.removeItem("Imtaqinmenubg");
    checkOptions();
...
function darkFn() {
    ...
    localStorage.removeItem("Imtaqinlighttheme");
    localStorage.removeItem("bodyBgRGB");
    localStorage.removeItem("ImtaqinbgColor");
    localStorage.removeItem("Imtaqinheaderbg");
    localStorage.removeItem("Imtaqinbgwhite");
...
function checkOptions() {
    ...
    // light header
    if (localStorage.getItem('ImtaqinHeader') === "light") {
        document.querySelector('#switcher-header-light').checked = true;
    }

    // color header
    if (localStorage.getItem('ImtaqinHeader') === "color") {
        document.querySelector('#switcher-header-primary').checked = true;
    }

    // gradient header
    if (localStorage.getItem('ImtaqinHeader') === "gradient") {
        document.querySelector('#switcher-header-gradient').checked = true;
    }

    // dark header
    if (localStorage.getItem('ImtaqinHeader') === "dark") {
        document.querySelector('#switcher-header-dark').checked = true;
    }
    // transparent header
    if (localStorage.getItem('ImtaqinHeader') === "transparent") {
        document.querySelector('#switcher-header-transparent').checked = true;
    }

    // light menu
    if (localStorage.getItem('ImtaqinMenu') === 'light') {
        document.querySelector('#switcher-menu-light').checked = true;
    }

    // color menu
    if (localStorage.getItem('ImtaqinMenu') === 'color') {
        document.querySelector('#switcher-menu-primary').checked = true;
    }

    // gradient menu
    if (localStorage.getItem('ImtaqinMenu') === 'gradient') {
        document.querySelector('#switcher-menu-gradient').checked = true;
    }

    // dark menu
    if (localStorage.getItem('ImtaqinMenu') === 'dark') {
        document.querySelector('#switcher-menu-dark').checked = true;
    }
    // transparent menu
    if (localStorage.getItem('ImtaqinMenu') === 'transparent') {
        document.querySelector('#switcher-menu-transparent').checked = true;
    }

    //boxed
    if (localStorage.getItem('Imtaqinboxed')) {
        document.querySelector('#switcher-boxed').checked = true;
    }

    //scrollable
    if (localStorage.getItem('Imtaqinheaderscrollable')) {
        document.querySelector('#switcher-header-scroll').checked = true;
    }
    if (localStorage.getItem('Imtaqinmenuscrollable')) {
        document.querySelector('#switcher-menu-scroll').checked = true;
    }

    //fixed
    if (localStorage.getItem('Imtaqinheaderfixed')) {
        document.querySelector('#switcher-header-fixed').checked = true;
    }
    if (localStorage.getItem('Imtaqinmenufixed')) {
        document.querySelector('#switcher-menu-fixed').checked = true;
    }

    //classic
    if (localStorage.getItem('Imtaqinclassic')) {
        document.querySelector('#switcher-classic').checked = true;
    }

    //modern
    if (localStorage.getItem('Imtaqinmodern')) {
...
function updateColors() {
    ...
    if (document.querySelector("#Budgetoverview") !== null) {
        Budgetoverview();
    }
    ...
    if (document.querySelector("#sparkline-1") !== null) {
        sparkline1();
    }
}
updateColors()
